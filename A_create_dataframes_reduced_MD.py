...
def MD_features_implementation():
    ...
    dfs_in_dic = csv_to_dictionary.csvfiles_to_dic(reduced_dataframes_folder, exclude_files=['concat_ver.csv', 'concat_hor.csv','rdkit_min.csv','MD_output.csv', 'conformations_1000.csv', 'conformations_1000_mol_id.csv', public_variables.initial_dataframe, 'initial_dataframe_mol_id.csv']) # , '0ns.csv', '1ns.csv', '2ns.csv', '3ns.csv', '4ns.csv', '5ns.csv', '6ns.csv', '7ns.csv', '8ns.csv', '9ns.csv', '10ns.csv'
