...
def main(dfs_path = public_variables.dfs_descriptors_only_path_):
    ...
    dfs_dictionary = csv_to_dictionary.main(dfs_path,exclude_files=['concat_hor.csv','concat_ver.csv', 'big.csv','conformations_20.csv','conformations_50.csv','conformations_100.csv','conformations_200.csv','conformations_500.csv','conformations_1000.csv','conformations_1000_molid.csv'])#,'conformations_1000.csv','conformations_1000_molid.csv'])
